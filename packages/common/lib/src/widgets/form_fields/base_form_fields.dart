            ...
            children: [
              TextSpan(
                ...
                style: theme.textTheme.titleLarge?.copyWith(
                  color: theme.expenseTrackerColorsExtensions.onBackground,
                ),
              ),
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          decoration: InputDecoration(
            filled: true,
            fillColor: theme.expenseTrackerColorsExtensions.background,
            enabledBorder: OutlineInputBorder(
              borderSide: BorderSide(
                width: 2,
                color: theme.expenseTrackerColorsExtensions.background,
              ),
            ...
            focusedBorder: OutlineInputBorder(
              borderSide: BorderSide(
                width: 2,
                color: theme.expenseTrackerColorsExtensions.primary,
              ),
              borderRadius: BorderRadius.circular(
                Dimensions.of(context).radii.medium,
              ),
            ...
            focusedErrorBorder: OutlineInputBorder(
              borderSide: BorderSide(
                width: 2,
                color: theme.expenseTrackerColorsExtensions.error,
              ),
              borderRadius: BorderRadius.circular(
                Dimensions.of(context).radii.medium,
              ),
          ...
          iconEnabledColor: theme.expenseTrackerColorsExtensions.onBackground,
  ...
  static InputDecoration decoration(BuildContext context, bool isPassword,
    ...
    return InputDecoration(
      ...
      suffixIcon: isPassword
        ...
        onPressed: () => callback!(),
        icon: obscureText
            ? Icon(Icons.visibility_off,color: Theme.of(context).expenseTrackerColorsExtensions.primary,)
            : Icon(Icons.visibility,color: Theme.of(context).expenseTrackerColorsExtensions.primary,),
      )
          : null,
      fillColor: Theme.of(context).expenseTrackerColorsExtensions.background,
      filled: true,
      hintStyle: Theme.of(context).textTheme.titleLarge?.copyWith(
        color:
        Theme.of(context).expenseTrackerColorsExtensions.onBackground,
        fontWeight: FontWeight.w400,
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.r),
        borderSide: BorderSide(
          color: Theme.of(context).expenseTrackerColorsExtensions.secondary,
        ),
      ),
      focusedErrorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.r),
        borderSide: BorderSide(
          color: Theme.of(context).expenseTrackerColorsExtensions.error,
        ),
      ),
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12.r),
        borderSide: BorderSide(
          color: Theme.of(context).expenseTrackerColorsExtensions.primary,
        ),
      ),
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.r),
      ...
      disabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10.r),
        borderSide: BorderSide(
          color: Theme.of(context).expenseTrackerColorsExtensions.border,
        ),
      ),
    );
  }
    ...
    return DropdownButtonFormField(
      ...
      decoration: InputDecoration(
        enabledBorder: OutlineInputBorder(
          borderSide: BorderSide(
            width: 2,
            color: theme.expenseTrackerColorsExtensions.border,
          ),
        ),
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(
      ...
      isDense: true,
      iconEnabledColor: theme.expenseTrackerColorsExtensions.primary,
      autovalidateMode: AutovalidateMode.onUserInteraction,
      validator: widget.validator,
      // value: value,
      ...
      items: widget.options
        ...
        return DropdownMenuItem<String>(
          value: '$item', // Adding index to make values unique
          child: Text(item),
        );
      }).toList(),
    );
