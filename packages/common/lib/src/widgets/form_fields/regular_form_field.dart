          ...
          child: TextFormField(
           ...
           // focusNode: _focusNode,
            ...
            decoration: InputDecoration(
              fillColor:  widget.enabled == false ? theme.expenseTrackerColorsExtensions.background.withOpacity(0.4) : theme.expenseTrackerColorsExtensions.background,
              filled: true,
              hintText: widget.hintText,
              hintStyle: theme.textTheme.titleMedium?.copyWith(
                color:
                theme.expenseTrackerColorsExtensions.onBackground,
                fontWeight: FontWeight.w400,
              ),
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: theme.textTheme.headlineSmall?.copyWith(
          color: theme.expenseTrackerColorsExtensions.onBackground.withOpacity(0.4),
